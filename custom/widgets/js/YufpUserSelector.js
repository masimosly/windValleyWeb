        ...
        methods: {
            createData: function() {
                ...
                if (temp.user.dataParams.roleId == "") {
                    ...
                    me.setOptionsByUrl(2, backend.adminService + "/api/util/getrolebyuser");
                }
                ...
                if (temp.user.dataParams.dutyId == "") {
                    ...
                    me.setOptionsByUrl(temp.user.fieldData.length - 1, backend.adminService + "/api/util/getdutybyuser");
                }
            ...
            getDefaultData: function() {
                ...
                return {
                    ...
                    user: {
                        ...
                        dataUrl: backend.adminService + "/api/util/getuser",
                        dataParams: {
                            roleId: "",
                            dutyId: "",
                            orgCode: yufp.session.org.code
