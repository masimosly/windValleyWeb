...
var demoMenus = [
   ...
   // { menuId: 'gm-20000', menuName: '基础教程', upMenuId: '0', menuIcon: 'el-icon-yx-books'},
	{ menuId: 'gm-20001', menuName: '系统管理', upMenuId: '0', menuIcon: 'el-icon-yx-books'},
    //二级菜单
    ...
    { menuId: 'ru-24000', menuName: '用户管理', upMenuId: 'gm-20001', menuIcon: 'el-icon-yx-price-tag',funcId: 'blank1', funcUrl: 'pages/example/blank/blank'},
