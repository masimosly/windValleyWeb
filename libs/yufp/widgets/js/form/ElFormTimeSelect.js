...
(function (vue,$, name) {
    ...
    vue.component(name, {
        ...
        :rules="rules" :error="error" :label-width="labelWidth" :showMessage="showMessage">\
                <el-time-select v-model="model" :isRange="isRange" :placeholder="placeholder" :size="size" :format="format"\
